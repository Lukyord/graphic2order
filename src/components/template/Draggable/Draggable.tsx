...
export function Draggable({
  ...
  const updatePositionState = useCallback(
    (newTopPx: number, newLeftPx: number, isMobileView: boolean) => {
      ...
      const newTop = pixelsToPosition(newTopPx, viewportPosition.top || DEFAULT_POSITION, true)
      const newLeft = pixelsToPosition(newLeftPx, viewportPosition.left || DEFAULT_POSITION, false)
  ...
  const updatePosition = useCallback(
    ...
    [isDragging, dragStartPos, elementStartPos, dragThreshold, startDragging, updatePositionState],
  )
